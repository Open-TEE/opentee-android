...
public class OTClient implements ITEEClient {
    ...
    @Override
    public IOperation Operation(IParameter firstParam) {
        return new OTOperation(0, firstParam);
    }

    @Override
    public IOperation Operation(IParameter firstParam, IParameter secondParam) {
        return new OTOperation(0, firstParam, secondParam);
    }

    @Override
    public IOperation Operation(IParameter firstParam, IParameter secondParam, IParameter thirdParam) {
        return new OTOperation(0, firstParam, secondParam, thirdParam);
    }

    @Override
    public IOperation Operation(IParameter firstParam, IParameter secondParam, IParameter thirdParam, IParameter forthParam) {
        return new OTOperation(0, firstParam, secondParam, thirdParam, forthParam);
    }

    @Override
    public IRegisteredMemoryReference RegisteredMemoryReference(ISharedMemory sharedMemory, IRegisteredMemoryReference.Flag flag, int offset) throws BadParametersException {
    ...
    @Override
    public IValue Value(IValue.Flag flag, int a, int b) {
