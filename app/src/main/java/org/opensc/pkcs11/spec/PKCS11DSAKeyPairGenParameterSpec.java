...
/**
 * This extension of {@link DSAKParameterSpec} is used to initialize the
 ...
 * @author wglas
 */
public class PKCS11DSAKeyPairGenParameterSpec extends DSAParameterSpec implements PKCS11KeyPairGenParams
{
    private byte[] id;
     ...
     * parameters.
     * 
     * @param p The DSA prime.
     * @param q The DSA subprime.
     * @param g The DSA base.
     * 
     * @see DSAParameterSpec#DSAParameterSpec(BigInteger, BigInteger, BigInteger)
     */
    public PKCS11DSAKeyPairGenParameterSpec(BigInteger p, BigInteger q, BigInteger g)
    {
        super(p, q, g);
        this.signing = true;
        this.verify = true;
